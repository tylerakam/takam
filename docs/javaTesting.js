window.onload = alert ('Enter if you dare!');

function ad() {
  document.getElementById("sub").innerHTML = "Subscribe! (oops, the link is gone. go to Chiefofbricks!)";
}
function bigImg(x) {
  x.style.height = "439.5px";
  x.style.width = "1212px";
}

function normalImg(x) {
  x.style.height = "293px";
  x.style.width = "808px";
}
